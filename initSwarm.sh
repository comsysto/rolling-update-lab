...
docker service create --replicas 1 --name rollingupdate --network rollingupdate_network  --publish 8080:8080 --env JAVA_OPTS="-Dspring.datasource.host=postgres -Dspring.datasource.port=5432" rollingupdate:v1.0  ping postgres
